  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          className="bg-brand-secondary hover:bg-brand hover:text-primary-black mt-8 inline-block w-fit cursor-pointer rounded-full px-5 py-2.5 text-xs text-white shadow-[0_0_15px_rgba(34,211,238,0.5)] backdrop-blur-xl transition-all duration-300 ease-in-out hover:scale-105 md:text-sm lg:px-6 lg:py-3"
          type="submit"
        >
          Send Message
        </button>
