      ...
      <div className="flex flex-col gap-y-8">
        <div>
          ...
          <p className="text-primary mt-4 text-xs font-light lg:text-sm">
            Offrez à vos utilisateurs une expérience fluide et intuitive grâce à
            un design UX/UI centré sur l’humain. Je conçois des interfaces
            claires qui facilitent la navigation et renforcent l’engagement.
          </p>
        </div>
        <div>
            ...
            <li className="flex items-center gap-x-2">
              <span>
                <svg
                  ...
                  className="text-brand size-4 lg:size-5"
                >
                  <path
              ...
              <span>Recherche utilisateur & audit rapide inclus</span>
            </li>
            <li className="flex items-center gap-x-2">
              <span>
                <svg
